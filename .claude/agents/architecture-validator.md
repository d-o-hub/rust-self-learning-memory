...
```bash
# Update .claude/agents/architecture-validator.md
...
Update other .claude/ .md files:
```bash
# Update .claude/CLAUDE.md if workflow changes
...
**When to update other .claude/ files**:
- Workflow changes
