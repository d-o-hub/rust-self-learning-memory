Refactor code using GOAP agent orchestration.

Systematic refactoring with multi-agent handoff coordination.

Usage: /refactor-goap [what to refactor]
...
2. GOAP agent decomposes refactoring into subtasks
3. Spawn specialized agents (1-8) with handoff coordination:
   - refactorer: Core refactoring
...
- Commit: git commit -m "refactor(module): description"
