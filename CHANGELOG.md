...
- add `pattern extract` command with --episode-id and --all flags (G-P1-12) ([1a043d0](https://github.com/d-o-hub/rust-self-learning-memory/commit/1a043d008e6c6706dd9cb641ae81eb37bd6ff002))

- r-f8 relationship info show polish with box-drawing panel ([61a9fb7](https://github.com/d-o-hub/rust-self-learning-memory/commit/61a9fb7b2717e709afe7450a926a8c343e125d74))

- r-f9 hnsw persistence, load, and capacity eviction ([d08633d](https://github.com/d-o-hub/rust-self-learning-memory/commit/d08633dd4fbbc01e5cc0cadb719c05bce8cab54d))

- add 6 domain skills (40 total, all routed) + update plans ([b9f461e](https://github.com/d-o-hub/rust-self-learning-memory/commit/b9f461e9fcc853833bebd2e3509b33a6df5f31e6))

- implement ADR-077 runtime embedding activation ([9ef4b74](https://github.com/d-o-hub/rust-self-learning-memory/commit/9ef4b742d4be41c722dc332c0e615c6784fa7732))


### CI/CD

- add environment: crates.io to all publish jobs ([11ff10e](https://github.com/d-o-hub/rust-self-learning-memory/commit/11ff10ef9ab6f0951adb1752f1d2940e4cba4cff))

- bump the actions-all group with 4 updates (#902) ([0e4bfa7](https://github.com/d-o-hub/rust-self-learning-memory/commit/0e4bfa714d75c4964daff820acbf3849e8df3e77))


### Documentation

- mark post-bump R-A2 complete after #886 merge ([799aeb3](https://github.com/d-o-hub/rust-self-learning-memory/commit/799aeb395612783c6e86d3ad80ee59fcc4712b32))

- refresh progress for post-v0.1.36 state (2026-07-23) ([5739edc](https://github.com/d-o-hub/rust-self-learning-memory/commit/5739edc50178b98f1488a5feb4bd02978114ab2e))

- synchronize README and internal documentation with current implementation state (#890) ([7d0c7bc](https://github.com/d-o-hub/rust-self-learning-memory/commit/7d0c7bc5d4b98d08e1240c2e0bbb3d2eb3418f48))

- mark ADR-074 as Accepted / Implemented (ACT-318) ([d846358](https://github.com/d-o-hub/rust-self-learning-memory/commit/d84635871ad17471c703c0899dfe4833b0644af2))

- mark ADR-071/072/073 as Accepted/Implemented; refresh status docs ([7c854ef](https://github.com/d-o-hub/rust-self-learning-memory/commit/7c854efb0166c3fae1287f49ed009aef776b0bdb))

- document ADR-077 runtime activation contract (REA A6) ([1e0ed2f](https://github.com/d-o-hub/rust-self-learning-memory/commit/1e0ed2f4cc8292b271c7c0cde61173ab27db3d57))

- fix stale ConfigureEmbeddingsOutput rustdoc for ADR-077 ([93481f4](https://github.com/d-o-hub/rust-self-learning-memory/commit/93481f41e90d2e70362fafa63d184ee8919bfcce))

- reconcile trackers to post-ADR-077 (#897) merged state ([2a7c943](https://github.com/d-o-hub/rust-self-learning-memory/commit/2a7c943f355d65b05b95867c0b6490cab78b4b5b))

- update trackers for PR queue cleanup (5 PRs → 0 open) (#905) ([45c6eee](https://github.com/d-o-hub/rust-self-learning-memory/commit/45c6eee86ec8be934b96c4e9cab3b77d726cf1b4))


### Fixed

- include v0.1.37 marker for docs integrity gate ([a415e58](https://github.com/d-o-hub/rust-self-learning-memory/commit/a415e5876de72f35517de762c0ac2d5c62739cb3))

- remove dead count_before lock, return total linked, add integration test ([f42c111](https://github.com/d-o-hub/rust-self-learning-memory/commit/f42c11129d177b51d20a2f6cd37a449a3b669a5a))

- correct cargo-mutants --file paths for workspace layout (#901) ([f6ae221](https://github.com/d-o-hub/rust-self-learning-memory/commit/f6ae2217432a1f947eee0c243ae3b18e187ae14d))

- add historical fingerprints to gitleaks allowlist (#906) ([07d699e](https://github.com/d-o-hub/rust-self-learning-memory/commit/07d699e54764a2b79cd0b65ae34641f47b076d5e))

- allow release commit type and prep v0.1.37 trackers (#909) ([917ca36](https://github.com/d-o-hub/rust-self-learning-memory/commit/917ca3697673cc761c496773b15e86b3dec4c556))


### Maintenance

- bump workspace to 0.1.37 after shipping v0.1.36 ([24388d5](https://github.com/d-o-hub/rust-self-learning-memory/commit/24388d54c97e3b760e20a7633edb7ac21d495524))

- update CHANGELOG.md for v0.1.36 [skip ci] (#887) ([9a580fc](https://github.com/d-o-hub/rust-self-learning-memory/commit/9a580fc9e675cedbe5a98319a9e0f40c558c279b))

- refresh plans to reflect all merged PRs (2026-07-24) ([1a98b66](https://github.com/d-o-hub/rust-self-learning-memory/commit/1a98b66fe5942f5a4c36bce5ca9a90ae7f6555c1))

- mark ADR-077 A1-A6 complete and refresh trackers ([648e11a](https://github.com/d-o-hub/rust-self-learning-memory/commit/648e11adf8e536cfba3ea850ed9adec5e3564632))

- bump the rust-major group with 3 updates (#904) ([956b5b0](https://github.com/d-o-hub/rust-self-learning-memory/commit/956b5b0d1a282ba1f2f4402abefb27bcfd2480ad))

- bump the rust-patch-minor group with 14 updates (#903) ([9b14a7a](https://github.com/d-o-hub/rust-self-learning-memory/commit/9b14a7a66a50b932654d374cf459f23d78551c23))

- add .claude/worktrees/ to .gitignore and remove stale worktrees (#908) ([296fc25](https://github.com/d-o-hub/rust-self-learning-memory/commit/296fc2510a814669033f8de52a50cf33fcfeb2ff))


### Performance

- optimize cosine similarity calculation with unrolled accumulators ([871062f](https://github.com/d-o-hub/rust-self-learning-memory/commit/871062ff62f24531e759aaf4a755bd8196a192d0))


### Testing

- add coverage for extract --all non-empty path and dispatch arm ([4bb4877](https://github.com/d-o-hub/rust-self-learning-memory/commit/4bb4877f3b9c2eccd1ab14ab6c26bd7b783c60e1))

- add unit tests for InfoResult::write_human to cover Codecov lines ([5b4b977](https://github.com/d-o-hub/rust-self-learning-memory/commit/5b4b97767d2f7a1f579718bf4f47151b8681a0d2))

- add coverage tests for ADR-077 uncovered branches ([e0f7f71](https://github.com/d-o-hub/rust-self-learning-memory/commit/e0f7f712fdc2b4c8b9701891bbb5e733eb3848c8))

- add ADR-077 A6 concurrency + credential-redaction tests ([b186909](https://github.com/d-o-hub/rust-self-learning-memory/commit/b18690910e2b6fef453b26ca51c1d90949b0a8a2))


### release

- prepare v0.1.37 (31 commits since v0.1.36) (#907) ([c23f575](https://github.com/d-o-hub/rust-self-learning-memory/commit/c23f575258c8388cda38afba0c153f43400fe5b5))
...
- one canonical ship path + release-guard skill ([75f9711](https://github.com/d-o-hub/rust-self-learning-memory/commit/75f97117dab2af4d6d1983361dbf1e9a81c6261e))

- S1.7 audit hardening + K3.1b/W2.1b skill and gate CI (#860) ([7dc86d3](https://github.com/d-o-hub/rust-self-learning-memory/commit/7dc86d31fadcc71d8b25128f1de77082ccdc772f))

- implement harness engineering sprint (Issues #861-#869) (#870) ([0cc90bf](https://github.com/d-o-hub/rust-self-learning-memory/commit/0cc90bfe47d65108d8a53285b6d725bd95b915b9))

- add release-cadence-manager skill with GOAP orchestrator ([ca00f04](https://github.com/d-o-hub/rust-self-learning-memory/commit/ca00f0403cd4933ebb5e14296d581973716259aa))

- land goap missing tasks through w2.5 ([7593406](https://github.com/d-o-hub/rust-self-learning-memory/commit/7593406dd0949612ccaea8617b1c9300591bb1e9))

- implement f4 pilots and s1.5b model integrity ([9679480](https://github.com/d-o-hub/rust-self-learning-memory/commit/9679480ce6150f34bdc64c850d1f3db8cb4a377a))

- complete ledger validators spikes and mcp provenance ([6c553c4](https://github.com/d-o-hub/rust-self-learning-memory/commit/6c553c4c6f606e8ff356fa6b48c47f3d099fbda0))

- add storage journal operator command for F4.2 ([68db07d](https://github.com/d-o-hub/rust-self-learning-memory/commit/68db07d95c18bc95d16d8730929e675deed5d9af))

- complete recommendations backlog (skills, gates, docs, release) ([1ebab99](https://github.com/d-o-hub/rust-self-learning-memory/commit/1ebab995c8e367b4657571fd435f43f44055cc1d))

- expand medium-risk evals and refresh plans truth ([44bf599](https://github.com/d-o-hub/rust-self-learning-memory/commit/44bf59952520d58048742703303f0d2a4178d0cd))


### CI/CD

- bump the actions-all group with 4 updates ([108f6aa](https://github.com/d-o-hub/rust-self-learning-memory/commit/108f6aa7483c2fb2f284d29a34aeff666cd350ce))


### Changed

- rustfmt pattern_accuracy tests ([1e5b0ed](https://github.com/d-o-hub/rust-self-learning-memory/commit/1e5b0edc654c6e279a37cb91768451a4fa69bff1))

- split embedding provider configs under 500 LOC ([d34f569](https://github.com/d-o-hub/rust-self-learning-memory/commit/d34f569723f47c8062ae756084ae795a27b5c762))


### Documentation

- consolidate backlog and archive superseded GOAP plans ([54caed6](https://github.com/d-o-hub/rust-self-learning-memory/commit/54caed60c4e5080f29d13478e9d39628e6788b11))

- align AGENTS skills table, TECH_DEBT, and CHANGELOG ([2b39d3c](https://github.com/d-o-hub/rust-self-learning-memory/commit/2b39d3c1d5db3f7171428eead71e306d886c108d))

- point GOAP_STATE at PR #878 ([a9308e5](https://github.com/d-o-hub/rust-self-learning-memory/commit/a9308e57103532996fe03b9cd1fe88d16c9659ab))

- finalize documentation for v0.1.36 ([938e391](https://github.com/d-o-hub/rust-self-learning-memory/commit/938e39165f6832d43bb6198fce9ca202e9a098ff))

- refresh tracker for open PRs, gaps, and release state (#881) ([2e10b90](https://github.com/d-o-hub/rust-self-learning-memory/commit/2e10b90307c0fe08355cbc25bc8b8a76d956631a))


### Fixed

- prevent cancelled Check Quick Check Status in yaml-lint workflow (#871) ([5bf2da7](https://github.com/d-o-hub/rust-self-learning-memory/commit/5bf2da749bc411b5727e404ca47d5d4d150c67f9))

- restore drift gate; ban GHA expr in bash ([0cd2fb7](https://github.com/d-o-hub/rust-self-learning-memory/commit/0cd2fb7a14441f69b1b0e0b954dff9558b00c06b))

- add skill evals for release-cadence-manager ([50de93a](https://github.com/d-o-hub/rust-self-learning-memory/commit/50de93a78c914f11c55b68a27accaa54b17ff3d1))

- document CLI in skill + fix evals ([fdf7240](https://github.com/d-o-hub/rust-self-learning-memory/commit/fdf72405349447c051edb85db312f82ce2afbe02))

- ignore skill-rules.json in changed skill evals ([c27cae3](https://github.com/d-o-hub/rust-self-learning-memory/commit/c27cae3eb6baa30562ed55ba62461f86d1cf4e82))

- restore pattern_accuracy target and portable ignore count ([20c5b87](https://github.com/d-o-hub/rust-self-learning-memory/commit/20c5b8757e770158f63cc1fa42fff67f0104ba91))

- allow must_use_candidate in pattern_accuracy tests ([46cb463](https://github.com/d-o-hub/rust-self-learning-memory/commit/46cb46315bf477df91c69aaf3f9b7944773d1e1f))

- resolve rustdoc link for QueryMemoryRequest ([723b07a](https://github.com/d-o-hub/rust-self-learning-memory/commit/723b07a84e7d660369fa3e9dcfbc13cff1a681f1))

- parse criterion estimates with jq for benchmarks ([3de713b](https://github.com/d-o-hub/rust-self-learning-memory/commit/3de713b441bba06302661fa241e6f0d6a362f6cd))

- adapt to sha2 0.11, lz4_flex 0.14, cargo_metadata 0.23 ([45da8f0](https://github.com/d-o-hub/rust-self-learning-memory/commit/45da8f0344136d611038c013e3d6c5efe8d9186f))

- unblock release-manager ship with docs integrity gate ([233a18f](https://github.com/d-o-hub/rust-self-learning-memory/commit/233a18f8d112d18747b5d8ce8ed26c7da425b2c5))


### Maintenance

- complete routes, ci-poll evals, and SKILLS.md index ([ec61317](https://github.com/d-o-hub/rust-self-learning-memory/commit/ec61317ec531bdf79d36385569a7a76c7b232588))

- bump the rust-major group with 3 updates ([4255e92](https://github.com/d-o-hub/rust-self-learning-memory/commit/4255e92707cda084cd3426d7b1502634998d26a8))
