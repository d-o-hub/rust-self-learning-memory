...
impl SelfLearningMemory {
    ...
    pub async fn start_episode(
        ...
        self.event_emitter.emit(crate::types::event::MemoryEvent::TaskStarted {
            task_id: episode_id,
    ...
    /// let step1 = ExecutionStep::new(1, "file_reader".to_string(), "Read config.toml".to_string())
    ///     .with_parameters(serde_json::json!({ "path": "config.toml" }));
    /// let mut step1 = step1;
