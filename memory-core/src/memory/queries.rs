...
pub async fn list_episodes_by_tags(
    memory: &crate::memory::SelfLearningMemory,
    tags: Vec<String>,
    match_all: bool,
    limit: Option<usize>,
) -> Result<Vec<Episode>> {
    ...
    let all_episodes = get_all_episodes(
...
pub async fn get_all_tags(memory: &crate::memory::SelfLearningMemory) -> Result<Vec<String>> {
