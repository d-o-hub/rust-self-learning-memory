...
//!
//! This module provides the MCP tool integration for advanced pattern analysis,
//! combining statistical analysis, predictive modeling, and causal inference capabilities.
...
impl AdvancedPatternAnalysisTool {
    ...
    /// Execute the advanced pattern analysis
    ...
    fn generate_summary(
        ...
        if let Some(stats) = statistical {
            ...
            if !stats.changepoints.is_empty() {
                ...
                recommendations.push("Investigate the causes of detected changepoints".to_string());
            }
        ...
        if let Some(pred) = predictive {
            ...
            if total_anomalies > 0 {
                ...
                recommendations
                    .push("Investigate the detected anomalies for potential issues".to_string());
            }
    ...
    pub async fn extract_time_series_from_memory(
        ...
        for metric in metrics {
            ...
            for episode in &episodes {
                ...
                // This is a simplified extraction - in practice, you'd parse the episode JSON
                match metric {
                    "execution_time_ms" => {
