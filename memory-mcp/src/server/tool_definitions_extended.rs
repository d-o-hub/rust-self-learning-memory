//! Extended tool definitions for episodes and batch operations.

use crate::types::Tool;
use serde_json::json;

mod relationship_tools;

/// Create the extended tool definitions.
pub fn create_extended_tools() -> Vec<Tool> {
    ...
    relationship_tools::append_episode_relationship_tools(&mut tools);
