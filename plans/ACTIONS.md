...
| ACT-363 | Canonicalize ADR-025/054 aliases (move to `plans/adr/_aliases/`) to make the ADR registry unique | G-P1-8 | ✅ `validate-plans.sh --identifiers` now sees 50 unique ADR numbers |
