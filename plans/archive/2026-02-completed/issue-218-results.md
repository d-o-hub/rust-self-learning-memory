...
**File**: `do-memory-core/src/memory/retrieval/helpers.rs`
...
**Files**:
- `do-memory-storage-turso/src/storage/batch/pattern_batch.rs`
- `do-memory-storage-turso/src/storage/patterns.rs`
...
### 6. MCP Tool Updates
**Files**:
- `do-memory-mcp/src/mcp/tools/embeddings/tool/execute.rs`
- `do-memory-mcp/src/server/tools/core.rs`
- `do-memory-mcp/src/mcp/tools/quality_metrics/tool.rs`
- `do-memory-mcp/src/mcp/tools/advanced_pattern_analysis/tool.rs`
...
### 7. CLI Updates
**Files**:
- `do-memory-cli/src/commands/pattern_v2/pattern/analyze.rs`
- `do-memory-cli/src/commands/eval.rs`

Updated to convert `Vec<Arc<Episode>>` to `Vec<Episode>` only when needed for processing.

### 8. Test Updates
**File**: `do-memory-core/src/retrieval/cache/tests.rs`
...
|--------|--------|-------|-----------|
| do-memory-core (retrieval) | ~30 | 11 | 19 (63%) |
| do-memory-core (sync) | 12 | 1 | 11 (92%) |
| do-memory-storage-turso | ~102 | ~95 | 7 (7%) |
| do-memory-mcp | ~170 | ~165 | 5 (3%) |
| do-memory-cli | ~53 | ~50 | 3 (6%) |
...
1. `do-memory-core/src/memory/retrieval/context.rs` - Return type change
2. `do-memory-core/src/memory/retrieval/helpers.rs` - Helper function update
3. `do-memory-core/src/retrieval/cache/lru.rs` - Cache optimization
4. `do-memory-core/src/retrieval/cache/types.rs` - Type documentation
5. `do-memory-core/src/sync/conflict.rs` - Arc-based conflict resolution

### Storage Changes (2 files)
6. `do-memory-storage-turso/src/storage/batch/pattern_batch.rs`
7. `do-memory-storage-turso/src/storage/patterns.rs`

### MCP Tool Changes (4 files)
8. `do-memory-mcp/src/mcp/tools/embeddings/tool/execute.rs`
9. `do-memory-mcp/src/server/tools/core.rs`
10. `do-memory-mcp/src/mcp/tools/quality_metrics/tool.rs`
11. `do-memory-mcp/src/mcp/tools/advanced_pattern_analysis/tool.rs`

### CLI Changes (2 files)
12. `do-memory-cli/src/commands/pattern_v2/pattern/analyze.rs`
13. `do-memory-cli/src/commands/eval.rs`

### Test Changes (3 files)
14. `do-memory-core/src/retrieval/cache/tests.rs`
15. `do-memory-core/tests/storage_sync.rs` - Updated test calls
